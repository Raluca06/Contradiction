...
public class ConText {
	...
	String[] regexes = new String[]{"absence of ,pre,neg",
                                        ...
                                        "as has,termin,neg",
                                        "as needed,pre,hypo","as the cause for ,termin,neg","as the cause of ,termin,neg",
                                        "as the etiology for ,termin,neg","as the etiology of ,termin,neg","as the origin for ,termin,neg","as the origin of ,termin,neg","as the reason for ,termin,neg","as the reason of ,termin,neg","as the secondary cause for ,termin,neg","as the secondary cause of ,termin,neg","as the secondary etiology for ,termin,neg","as the secondary etiology of ,termin,neg","as the secondary origin for ,termin,neg","as the secondary origin of ,termin,neg","as the secondary reason for ,termin,neg","as the secondary reason of ,termin,neg","as the secondary source for ,termin,neg","as the secondary source of ,termin,neg","as the source for ,termin,neg","as the source of ,termin,neg","as well as any,pre,neg","aside from ,termin,neg","aunt,pre,exp","aunt's,pre,exp","be ruled out ,post,poss",
                                        "be ruled out for ,pre,poss","because,termin,hypo","being ruled out ,post,poss","brother,pre,exp",
                                        "brother's,pre,exp","but ,termin,neg","can be ruled out ,post,poss",
                                        "can be ruled out for ,pre,poss","can rule her out ,pre,neg","can rule her out against ,pre,neg","can rule her out for ,pre,neg",
                                        "can rule him out ,pre,neg","can rule him out against ,pre,neg","can rule him out for ,pre,neg","can rule out ,pre,neg","can rule out against ,pre,neg","can rule out for ,pre,neg","can rule the patient out ,pre,neg","can rule the patinet out against ,pre,neg","can rule the patinet out for ,pre,neg","cannot ,pre,neg","cause for ,termin,neg","cause of ,termin,neg","causes for ,termin,neg","causes of ,termin,neg","checked for ,pre,neg",
                                        "clear of,pre,neg","come back for,pre,hypo","come back to,pre,hypo","complains,termin,histexp",
                                        "could be ruled out ,post,poss","could be ruled out for ,pre,poss",
			...
			"history,pre,hist",
                        ...
                        "however ,termin,neg","if,pre,hypo",
